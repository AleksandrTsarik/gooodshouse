...
const catalogFilter = {
	...
	filterOpen: function(obj, remove){
		var t = this;
		if(!remove)	{
	...
	toggleCategory: function(obj){
		var t = this;
		$(t.categoryBlock).toggleClass('is-open')
	},
	showFilterItems: function(obj, remove) {
		var t = this;
	...
	function drawShopsList(shops) {
		if (objectManager) {
			...
			$shops.on('click', function() {
				...
				let addressInfo = $(this).data('address');				
